    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <h5 class="d-flex align-items-center mt-5">Cronologia</h5>
                ...
                <table class='table table-light table-bordered table-hover table-striped'>
                    <thead class='thead-dark'> 
                        <tr> 
                            ...
                            <th scope='col' class='w-50'>URL</th> 
                        </tr>
                    </thead>";
                foreach ($data as $line) {
                    echo "<tr>
                <th scope='row'>" . $line["data"] . "</th>" . "
                <th scope='row' style='cursor: pointer' onclick=\"docx(this)\">" . $line["url"] . "</th>
               </tr>";
                }
                echo "</tr> </table> </div>"
                ?>
